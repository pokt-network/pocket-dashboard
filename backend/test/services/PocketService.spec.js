...
/** @type {string} */
const ACCOUNT_WITH_POKT = process.env.TEST_ACCOUNT_WITH_POKT;
  ...
  if (ACCOUNT_WITH_POKT) {
    describe("stakeApplication", () => {
      it("Expected a transaction hash successfully", async () => {
        ...
        transaction.should.not.to.be.empty;
      });
    });
  }
});
