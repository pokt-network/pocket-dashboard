    ...
    return (
      ...
      >
        ...
        <p>
          ...
          fees and costs of investigation, to which they may be put or which
          they may reasonably incur or sustain due to or arising out of (i) any
          inaccuracy in or breach of any representation or warranty of Purchaser
          or its affiliates or agents, whether contained in this Agreement or
          any other document provided by Purchaser to the Company in connection
          with Purchaser’s purchase and use of the Tokens, or (ii) any
          nonfulfillment or breach of any covenant, agreement, or other
          provision by Purchaser or its affiliates or agents, whether contained
          in this Agreement or any other document provided by Purchaser to the
          Company in connection with Purchaser’s purchase and use the Tokens.
          All indemnification provisions shall survive the termination of this
          Agreement.
        </p>
        <ol className="bold-ordered-list" start="12">
          <li>
            <p>
              <b>
                <u>Limitation of Liability; No Warranties.</u>
              </b>
            </p>
          </li>
          <ol className="ordered-list">
            <li>
              <p>
                Except as expressly provided by this agreement and applicable
                laws, the Company shall not be responsible or liable for any
                losses resulting directly or indirectly from (i) any act or
                omission of Purchaser or agent of Purchaser or any error,
            ...
            <li>
              <p>
                TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAWS AND RULES,
                THE COMPANY, ITS AFFILIATES, AND ITS CONTROLLING PERSONS,
          ...
          <ol className="ordered-list">
            <li>
              <p>
                <b>Survival.</b>
                Notwithstanding anything to the contrary herein, the provisions
                of Sections 4, 5, 6, 7, 8, 10, and 11 shall survive the
