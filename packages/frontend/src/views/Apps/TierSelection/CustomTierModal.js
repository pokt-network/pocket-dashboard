    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <p>
            The Stake and Scale is a plan for the apps to be able to purchase
            the desired amount of throughput and scale up the application as it
            grows without overpaying for infrastructure.
          </p>
          <p>
            In the Stake and Scale plan, the staked POKT is completely owned and
            managed by the user as well as the AAT (Application Authentication
            Token). The Pocket protocol uses a staking mechanism, which lets
            individuals access a daily allocated API throughput in perpetuity in
            relation to their POKT stake.Purchase the relays you need. It’s
            recommended to give your application a comfortable throughput buffer
            to account for usage spikes as you will not be able to exceed your
            throughput limit.
          </p>
          <p>
